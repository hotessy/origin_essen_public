      ...
      proof  (rule allI)
        ...
        proof (rule allI)
          ...
          proof  (rule impI)
            ...
            proof (rule notI)
              assume "(\<^bold>\<diamond>(\<^bold>\<forall>p'. P x z p' \<^bold>\<and> (\<^bold>\<forall>t.(\<^bold>\<not>(x \<^bold>=\<^sup>L t) \<^bold>\<rightarrow> \<^bold>\<not>(P t z p'))))) w"
              then have sufficiency3_ante: "(\<^bold>\<diamond>(P x z p \<^bold>\<and> (\<^bold>\<forall>t.(\<^bold>\<not>(x \<^bold>=\<^sup>L t) \<^bold>\<rightarrow> \<^bold>\<not>(P t z p))))) w" 
                by auto 
              ...
              have compossibilty3_ante: "((P x y p) \<^bold>\<and> \<^bold>\<not>(y \<^bold>=\<^sup>L z) \<^bold>\<and> \<^bold>\<diamond>(\<^bold>\<exists>t. P t z p \<^bold>\<and> (\<^bold>\<forall>t'.(\<^bold>\<not>(t \<^bold>=\<^sup>L t') \<^bold>\<rightarrow> \<^bold>\<not>(P t' z p))))) w" 
                using antecedent and sufficiency3_ante by auto
              ...
              from origin_uniqueness3 have "(\<^bold>\<forall>x. \<^bold>\<forall>y. \<^bold>\<forall>z. \<^bold>\<forall>p. \<^bold>\<not>(\<^bold>\<diamond>((P x y p) \<^bold>\<and> (P x z p) \<^bold>\<and> \<^bold>\<not>(y \<^bold>=\<^sup>L z)))) w"..
              ...
              then have "(\<^bold>\<not>((P x y p) \<^bold>\<and> (P x z p) \<^bold>\<and> \<^bold>\<not>(y \<^bold>=\<^sup>L z))) u" using `w r u` by auto
