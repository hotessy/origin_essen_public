theory v2_isar_new_K
  imports Main "../QML"
begin

text \<open>
@{text "Compossibility\<^sub>7'"}: Necessarily, given any two non-overlapping hunks, @{term y} and @{term z}, 
and a table, @{term x}, made from @{term y}, 
for any table, @{term x'}, that might be made from @{term z}, it 
